...
class NetMap(object):
    def __init__(self, xml_path, junction_list = []) -> None:
        ...
        self.net_data, self.connection_data, self.junction_data = self._import_edges_from_net(xml_path)
    ...
    def _import_edges_from_net(self, xml_path):
...
if __name__ == "__main__":
    map = NetMap('real_data/CSeditClean_1.net.xml', ['229','499','332','334', 'cluster_2059459190_2059459387_423609690_429990307_455858124_5692002934_8446346736', '140'])
